...
!(function () { return __awaiter(void 0, void 0, void 0, function () {
    var cookiesArr, i, lastgettime, food, petid, coins, _i, _a, day, taskRetCode;
    var _b, _c;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    url = TS_USER_AGENTS_1.h5st(url, stk, params);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
...
function api1(fn, stk, params) {
    ...
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = "https://m.jingxi.com/jxmc/" + fn + "?channel=7&sceneid=1001&activeid=" + activeid + "&activekey=null&step=B-1&jxmc_jstoken=" + jxToken.strPgUUNum + "&timestamp=" + jxToken.strPgtimestamp + "&phoneid=" + jxToken.strPhoneID + "&_stk=" + encodeURIComponent(stk) + "&_ste=1&_=" + Date.now() + "&sceneval=2&g_login_type=1&callback=jsonpCBKS&g_ty=ls";
...
function api3(fn, stk, params) {
    ...
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = "https://m.jingxi.com/jxmc/" + fn + "?channel=7&sceneid=1001&activeid=" + activeid + "&activekey=null&step=C-1&jxmc_jstoken=" + jxToken.strPgUUNum + "&timestamp=" + jxToken.strPgtimestamp + "&phoneid=" + jxToken.strPhoneID + "&_stk=" + encodeURIComponent(stk) + "&_ste=1&_=" + Date.now() + "&sceneval=2&g_login_type=1&callback=jsonpCBKS&g_ty=ls";
                    if (Object.keys(params).length !== 0) {
                        key = void 0;
                        for (key in params) {
                            if (params.hasOwnProperty(key))
