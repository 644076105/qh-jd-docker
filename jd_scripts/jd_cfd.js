    ...
    return __generator(this, function (_u) {
        switch (_u.label) {
            ...
            case 47:
                console.log('今日已经签到');
                _u.label = 48;
            case 48: return [4 /*yield*/, TS_USER_AGENTS_1.wait(2000)];
            case 49:
                _u.sent();
            ...
            case 54:
                ...
                _u.label = 55;
            case 55: return [4 /*yield*/, TS_USER_AGENTS_1.wait(1000)];
            case 56:
                _u.sent();
                return [4 /*yield*/, api('story/MermaidOper', '_cfd_t,bizCode,ddwTriggerDay,dwEnv,dwType,ptag,source,strStoryId,strZone', {
                        strStoryId: res.StoryInfo.StoryList[0].strStoryId,
            ...
            case 68:
                ...
                _u.label = 69;
            case 69: return [4 /*yield*/, TS_USER_AGENTS_1.wait(2000)];
            case 70:
                _u.sent();
                _u.label = 71;
            ...
            case 101:
                ...
                _u.label = 102;
            case 102: return [4 /*yield*/, TS_USER_AGENTS_1.wait(2000)
                // 导游
            ];
            case 103:
                _u.sent();
            ...
            case 109:
                _q++;
                return [3 /*break*/, 106];
            case 110: return [4 /*yield*/, TS_USER_AGENTS_1.wait(2000)];
            case 111:
                _u.sent();
