    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 35:
                _d.sent();
                return [3 /*break*/, 33];
            case 36: return [4 /*yield*/, TS_USER_AGENTS_1.wait(5000)];
            case 37:
                _d.sent();
                _d.label = 38;
            case 38:
            ...
            case 44:
                ...
                _d.label = 45;
            case 45: return [4 /*yield*/, TS_USER_AGENTS_1.wait(6000)];
            case 46:
                _d.sent();
                return [3 /*break*/, 48];
            case 47:
            ...
            case 49: return [4 /*yield*/, TS_USER_AGENTS_1.wait(4000)];
            case 50:
                _d.sent();
                _d.label = 51;
            case 51:
            ...
            case 60: return [4 /*yield*/, TS_USER_AGENTS_1.wait(5000)];
            case 61:
                _d.sent();
                _d.label = 62;
            case 62:
            ...
            case 75:
                ...
                shareCodesHb = __spreadArray(__spreadArray(__spreadArray([], shareCodesHbInterval), shareCodesHb_HW), data.data);
                return [3 /*break*/, 77];
            case 76:
                e_7 = _d.sent();
                console.log('获取助力池失败');
                shareCodesHb = __spreadArray(__spreadArray([], shareCodesHbInterval), shareCodesHb_HW);
                return [3 /*break*/, 77];
            case 77:
                cookie = cookiesArr[i];
                return [4 /*yield*/, token(cookie)];
            ...
            case 80:
                ...
                return [4 /*yield*/, TS_USER_AGENTS_1.wait(8000)];
            case 81:
                _d.sent();
                _d.label = 82;
            case 82:
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (['GetUserTaskStatusList', 'DoTask', 'Award'].indexOf(fn) > -1) {
                        ...
                        url = TS_USER_AGENTS_1.h5st(url, stk, params, 10028) + '&sceneval=2&g_login_type=1&g_ty=ajax';
                    }
                    else {
                        ...
                        url = TS_USER_AGENTS_1.h5st(url, stk, params, 10028) + ("&_=" + (Date.now() + 2) + "&sceneval=2&g_login_type=1&callback=jsonpCBK" + String.fromCharCode(Math.floor(Math.random() * 26) + "A".charCodeAt(0)) + "&g_ty=ls");
                    }
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
