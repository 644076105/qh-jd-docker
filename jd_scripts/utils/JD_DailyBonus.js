...
var OtherKey = `[{"cookie":"pt_key=AAJhTujgADCDIp8ZcptjdHanx1D0pZJKlCNw9QLlEgDDq0c0pGOYJswPPmnUKFst6SKKmDVAQSI;pt_pin=jd_59417aeb07201;","jrBody":""}]`; //无限账号Cookie json串数据, 请严格按照json格式填写, 具体格式请看以下样例:
