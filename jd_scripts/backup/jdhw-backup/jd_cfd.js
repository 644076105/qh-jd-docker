...
!(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_u) {
        switch (_u.label) {
            ...
            case 34: return [4 /*yield*/, TS_USER_AGENTS_1.wait(3000)];
            case 35:
                _u.sent();
                return [3 /*break*/, 20];
            ...
            case 43:
                _u.sent();
                if (!(TS_USER_AGENTS_1.getRandomNumberByRange(1, 4) === 2)) return [3 /*break*/, 46];
            ...
            case 67:
                ...
                _u.label = 68;
            case 68: return [4 /*yield*/, TS_USER_AGENTS_1.wait(1000)];
            case 69:
                _u.sent();
                return [4 /*yield*/, api('story/MermaidOper', '_cfd_t,bizCode,ddwTriggerDay,dwEnv,dwType,ptag,source,strStoryId,strZone', {
                        strStoryId: res.StoryInfo.StoryList[0].strStoryId,
            ...
            case 81:
                ...
                _u.label = 82;
            case 82: return [4 /*yield*/, TS_USER_AGENTS_1.wait(2000)];
            case 83:
                _u.sent();
                _u.label = 84;
            ...
            case 95:
                j++;
                return [3 /*break*/, 92];
            case 96: return [4 /*yield*/, TS_USER_AGENTS_1.wait(2000)
                // 任务➡️
            ];
            case 97:
                _u.sent();
            ...
            case 114:
                ...
                _u.label = 115;
            case 115: return [4 /*yield*/, TS_USER_AGENTS_1.wait(2000)
                // 导游
            ];
            case 116:
                _u.sent();
            ...
            case 122:
                _q++;
                return [3 /*break*/, 119];
            case 123: return [4 /*yield*/, TS_USER_AGENTS_1.wait(2000)];
            case 124:
                _u.sent();
            ...
            case 136:
                ...
                shareCodes = __spreadArray(__spreadArray(__spreadArray([], shareCodesSelf), shareCodesHW), data.data);
                return [3 /*break*/, 138];
            case 137:
                e_3 = _u.sent();
                console.log('获取助力池失败');
                shareCodes = __spreadArray(__spreadArray([], shareCodesSelf), shareCodesHW);
                return [3 /*break*/, 138];
            case 138:
                j = 0;
                _u.label = 139;
...
function api(fn, stk, params, taskPosition) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        url = TS_USER_AGENTS_1.h5st(url, stk, params, 10032);
